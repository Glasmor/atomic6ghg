...
class Commuting(Formula):
    ...
    def make_personal_vehicle(self):
        ...
        personal_vehicle = []
        self._total_emissions = {"personalVehicle": {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}}
    ...
    def make_public_transportation(self):
        ...
        self._total_emissions.update({"publicTransportation": {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}})

        self._total_emissions_by_transit = {transit: {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0} for transit in self.public_transit}
        ...
        for row in self.wks_data.get("publicTransportation", []):
            ...
            calculated_row = {
                ...
                "passengerMiles": passenger_miles,
                "CO2": co2_emissions,
                "CH4": ch4_emissions,
                "N2O": n2o_emissions,
            }
