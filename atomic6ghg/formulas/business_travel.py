...
class BusinessTravel(Formula):
    ...
    def make_personal_vehicle_rental_car_or_taxi(self):
        ...
        personal_vehicle = []
        self._total_emissions = {"personalVehicleRentalCarOrTaxiBusinessTravel": {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}}
        self._total_emissions_by_vehicle = {
            vehicle: {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0} for vehicle in self.personal_vehicles
        }
        ...
        for row in self.wks_data.get("personalVehicleRentalCarOrTaxiBusinessTravel", []):
            ...
            if vehicle:
                ...
                travel_factor_co2, travel_factor_ch4, travel_factor_n2o = 0.0, 0.0, 0.0
    ...
    def make_personal_vehicle_total(self):
        ...
        personal_vehicle_total = {
            "CO2": self._total_emissions["personalVehicleRentalCarOrTaxiBusinessTravel"]["CO2"],
    ...
    def make_rail_or_bus(self):
        ...
        rail_or_bus_vehicle = []
        self._total_emissions = {"railOrBusBusinessTravel": {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}}

        self._total_emissions_by_rail_or_bus = {
            rail_or_bus: {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0} for rail_or_bus in self.rail_or_bus
        }
    ...
    def make_rail_or_bus_total(self):
        ...
        rail_or_bus_total = {
            "CO2": self._total_emissions["railOrBusBusinessTravel"]["CO2"],
    ...
    def make_air_business_travel(self):
        ...
        air_vehicle = []
        self._total_emissions = {"airBusinessTravel": {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}}

        self._total_emissions_by_air = {
            flight_length: {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0} for flight_length in self.flight_length
        }
    ...
    def make_air_total(self):
        ...
        air_total = {
            "CO2": self._total_emissions["airBusinessTravel"]["CO2"],
    ...
    def make_co2_emissions_by_travel_type(self):
        ...
        self._total_emissions["total"] = {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}
        ...
        for transport_type in self.vehicle_types_all:
            ...
            calculated_row = {
                ...
                "CO2": self._total_emissions[transport_type]["CO2"],
    ...
    def make_co2_equivalent_emissions(self):
        ...
        total = (
            self._total_emissions["total"]["CO2"]
            + (self._total_emissions["total"]["CH4"] / 1000 * refrigerants_gwp_factors["ch4"])
            + (self._total_emissions["total"]["N2O"] / 1000 * refrigerants_gwp_factors["n2o"])
        ) / 1000
