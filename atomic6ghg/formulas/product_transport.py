...
class ProductTransport(Formula):
    ...
    def make_product_transport_by_vehicle_miles(self):
        ...
        self._total_emissions_by_vehicle_type_miles = {
            vehicle_type: {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0} for vehicle_type in self.vehicle_types_miles
        }
        self._total_emissions_by_miles = {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}
        for row in self.wks_data.get("productTransportByVehicleMiles", []):
            ...
            co2_emissions = ProductTransport.calculate_vehicle_emissions(vehicle_type, vehicle_miles, "co2", "vehicle-mile")
            ch4_emissions = ProductTransport.calculate_vehicle_emissions(vehicle_type, vehicle_miles, "ch4", "vehicle-mile")
            n2o_emissions = ProductTransport.calculate_vehicle_emissions(vehicle_type, vehicle_miles, "n2o", "vehicle-mile")
    ...
    def make_total_by_vehicle_miles(self):
        ...
        total_by_vehicle_miles = {
            "CO2": self._total_emissions_by_miles["CO2"],
    ...
    def make_product_transport_by_short_ton_miles(self):
        ...
        self._total_emissions_by_vehicle_type_short_ton = {
            vehicle_type: {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0} for vehicle_type in self.vehicle_types_short_ton
        }
        self._total_emissions_by_short_ton = {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}
        for row in self.wks_data.get("productTransportByTonMiles", []):
            ...
            co2_emissions = ProductTransport.calculate_vehicle_emissions(vehicle_type, short_ton_miles, "co2", "ton-mile")
            ch4_emissions = ProductTransport.calculate_vehicle_emissions(vehicle_type, short_ton_miles, "ch4", "ton-mile")
            n2o_emissions = ProductTransport.calculate_vehicle_emissions(vehicle_type, short_ton_miles, "n2o", "ton-mile")
    ...
    def make_total_by_ton_miles(self):
        ...
        total_by_ton_miles = {
            "CO2": self._total_emissions_by_short_ton["CO2"],
    ...
    def make_total_emissions_by_product_transport_type(self):
        ...
        for vehicle_type in self.vehicle_types_all:
            zero_dict = {"CO2": 0.0, "CH4": 0.0, "N2O": 0.0}
    ...
    def make_co2_equivalent_emissions(self):
        ...
        total = (
            refrigerants_gwp_factors["co2"] * co2_total
            + refrigerants_gwp_factors["ch4"] * ch4_total / 1000
            + refrigerants_gwp_factors["n2o"] * n2o_total / 1000
        ) / 1000
