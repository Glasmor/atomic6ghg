...
class Electricity(Formula):
    ...
    def make_emissions(self):
        ...
        self._total_emissions = {
            "electricityPurchased": 0.0,
            "marketBasedEmissionsCO2Emissions": 0.0,
            "marketBasedEmissionsCH4Emissions": 0.0,
            "marketBasedEmissionsN2OEmissions": 0.0,
            "locationBasedEmissionsCO2Emissions": 0.0,
            "locationBasedEmissionsCH4Emissions": 0.0,
            "locationBasedEmissionsN2OEmissions": 0.0,
        }
        emissions = []
        ...
        for row in self.wks_data.get("totalElectricityPurchased", []):
            ...
            market_based_emissions_co2_emissions = Electricity.calculate_market_based_emissions_electricity(
                electricity_purchased, market_based_emissions_factor_co2, subregion, "co2"
            )
            market_based_emissions_ch4_emissions = Electricity.calculate_market_based_emissions_electricity(
                electricity_purchased, market_based_emissions_factor_ch4, subregion, "ch4"
            )
            market_based_emissions_n2o_emissions = Electricity.calculate_market_based_emissions_electricity(
                electricity_purchased, market_based_emissions_factor_n2o, subregion, "n2o"
            )
            location_based_emissions_co2_emissions = Electricity.calculate_location_based_emissions_electricity(
                electricity_purchased, subregion, "co2"
            )
            location_based_emissions_ch4_emissions = Electricity.calculate_location_based_emissions_electricity(
                electricity_purchased, subregion, "ch4"
            )
            location_based_emissions_n2o_emissions = Electricity.calculate_location_based_emissions_electricity(
                electricity_purchased, subregion, "n2o"
            )
            ...
            emissions.append(
                {
                    "sourceId": source_id,
                    "sourceDescription": row.get("sourceDescription"),
                    "sourceArea": row.get("sourceArea"),
                    "eGridSubregion": subregion,
